...
export clas DiceRoller {
  ...
  private rollAttackDice(input: T.AttackInput, modifiedInput: T.AttackInput, status: AttackResultStatus) {
    // 1. Roll dice
  ...
  private convertAttackSurges(input: T.AttackInput, modifiedInput: T.AttackInput, status: AttackResultStatus) {
    // critical X
  ...
  private applyDodgeAndCover(input: T.AttackInput, modifiedInput: T.AttackInput, status: AttackResultStatus) {
    // cover
  ...
  private modifyAttackDice(input: T.AttackInput, modifiedInput: T.AttackInput, status: AttackResultStatus) {
    // impact X
  ...
  private rollDefenseDice(input: T.AttackInput, modifiedInput: T.AttackInput, status: AttackResultStatus) {
    // 1. Roll dice
  ...
  private rerollDefenseDice(defenseDiceCount: number, input: T.AttackInput, modifiedInput: T.AttackInput, status: AttackResultStatus) {
    // uncanny luck
  ...
  private convertDefenseSurges(input: T.AttackInput, modifiedInput: T.AttackInput, status: AttackResultStatus) {
    // surge -> block
    if(modifiedInput.defense.surge) {
  ...
  private modifyDefenseDice(input: T.AttackInput, modifiedInput: T.AttackInput, status: AttackResultStatus) {
    // apply pierce
    if(modifiedInput.offense.pierceX.active) {
  ...
  private compareResults(status: AttackResultStatus) {
