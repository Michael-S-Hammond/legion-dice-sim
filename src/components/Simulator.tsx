...
class Simulator extends React.Component<any, SSM.SimulatorState> { // eslint-disable-line @typescript-eslint/no-explicit-any
    private _stateManager: SSM.SimulatorStateManager;
    ...
    constructor(props: any) { // eslint-disable-line @typescript-eslint/no-explicit-any, @typescript-eslint/explicit-module-boundary-types
        ...
        this._stateManager = new SSM.SimulatorStateManager((newState: SSM.SimulatorState) => this.setState(newState));
